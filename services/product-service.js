...
module.exports = class ProductService {
  constructor() {
    this._client = new DynamoDB(process.env.DYNAMODB_ENDPOINT ? { endpoint: new Endpoint(process.env.DYNAMODB_ENDPOINT) } : undefined);
  ...
  async update(id, data) {
    await this.validateBeforeSave(data);
    const instance = new this._modelClass({ id, ...data });
